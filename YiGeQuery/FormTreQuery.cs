...
namespace YiGeQuery
{
    public partial class FormTreQuery : Form
    {
        public FormTreQuery ( )
        {
            InitializeComponent( );
        ...
        private void FormTreQuery_Load ( object sender ,EventArgs e )
        {
        ...
        private void button1_Click ( object sender ,EventArgs e )
        {
            ...
            {
                _model.TC009 = lookUpEdit3.Text;
                strWhere = strWhere + " AND TC009='" + _model.TC009 + "'";
            }
            ...
            file = "";
            file = Application.StartupPath + "\\领料单.frx";
            report.Load( file );
            createRDataSet( "领料单" ,strWhere );
            if ( signOf == "1" )
                return;
        ...
        void query ( )
        {
            ...
            tableOnly = _bll.GetDataTableOnlyNin( _model.TC003 ,_model.TC009 );
        ...
        private void lookUpEdit2_EditValueChanged ( object sender ,EventArgs e )
        {
            if ( lookUpEdit2.EditValue != null )
            {
                ...
                tableOnlys = _bll.GetDataTableOnlyNins( _model.TC001 ,_model.TC002 );
