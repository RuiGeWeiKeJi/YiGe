...
namespace Mulaolao.Class
{
    public class Encrypt
    {
        ...
        public static string GetDataTable ( )
        {
            ...
            strSql.Append( "select net_address from master..sysprocesses where net_address IN ('14187758A90E','14187758A90B','14187758A90C','14187758A90D')" );

            
            DataTable da= SqlHelper.ExecuteDataTable( strSql.ToString( ) );
            if ( da != null && da.Rows.Count > 0 )
                return encryPt( "YiGe" ,da.Rows[0]["net_address"].ToString( ) );
            else
                return null;
        }
    }
